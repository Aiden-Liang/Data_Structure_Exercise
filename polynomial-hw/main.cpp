...
int main()
{
   ...
   cout << "a polynomial is :" << a << endl;
   cout << endl;
   cout << "b polynomial is :" << b << endl;
   cout << endl;
   ...
   cout << endl << "c polynomial = " << c << endl;
   cout << endl << "c(x=2) = " << c(2) << endl;		// evaluate the polynomial with x=2 by horner's method
   cin.get();
}
